...
import { formatTime, isMini, isMobile } from '@/utils'
...
<template>
  <div :class="isMobile()?'':'px-4 '" class="w-full h-[calc(80vh-8rem)] relative inset-0 flex flex-col items-center">
    <div class="flex flex-1 flex-col gap-4 items-center justify-center w-full">
      ...
      <div :class="isMini()?'gap-11':'gap-14'"  class="flex items-center justify-center gap-14 w-2/4 mt-12">
